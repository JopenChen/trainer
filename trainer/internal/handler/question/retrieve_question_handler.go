...
func RetrieveQuestionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := question.NewRetrieveQuestionLogic(r.Context(), svcCtx)
		resp, err := l.RetrieveQuestion(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
